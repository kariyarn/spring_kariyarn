...
public class FileController {
	...
	public String upload(FileDto dto, HttpServletRequest request) {//FileDto의 필드에 MultipartFile 객체의 참조값이 들어있다.
	...
	public String upload(String title, MultipartFile myFile, HttpServletRequest request) {
		/*
		 * 입력한 제목은 title에 들어 있고, 업로드된 파일에 대한 정보는 myFile 객체에 들어 있다.
